...
static void MultiCellFromFile (int nbUE, string scheduler_type, int seed, string config_path)
{
  ...
  VoIP VoIPApplication[nbVoIP*n_cells*nbUE];
  TraceBased VideoApplication[nbVideo*n_cells*nbUE];
  InfiniteBuffer BEApplication[nbBE*n_cells*nbUE];
  CBR CBRApplication[nbCBR*n_cells*nbUE];
